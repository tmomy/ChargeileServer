...
from app.conf import log as sys_conf, pool_log_config, sqltime_log_config
...
pool_logging = build_log(pool_log_config)
sqltime_logging = build_log(sqltime_log_config)